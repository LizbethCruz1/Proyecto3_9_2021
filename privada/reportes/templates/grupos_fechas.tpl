...
<head>
	...
	<script type="text/javascript">
		function validar() {
			...
			ventanaCalendario = window.open("grupos_fechas1.php?fecha1=" + fecha1 + "&fecha2=" +fecha2 , "calendario", "width=600,height=550,left=100,top=100,scrollbars=yes,menubars=no,statusbar=NO,NO")
		}
	</script>
	{/literal}
</head>
<body>
	<center>
		<br>
		<h1> REPORTES DE GRUPOS CON FECHAS DE INSERCION</h1>
