		...
		<table class="listado">
			...
			<form name="formModif{$r.id_proveedor}" method="post" action="proveedores_modificar.php">
				<input type="hidden" name="id_proveedor" value="{$r.id_proveedor}">
				     <a href="javascript:document.formModif{$r.id_proveedor}.submit();" title="Modificar Proveedor en Sistema">
				     	Modificar>>
					 </a>
			</form>
			</td>
				<td align="center">
					<form name="formElimi{$r.id_proveedor}" method="post" action="proveedores_eliminar.php">
						<input type="hidden" name="id_proveedor" value="{$r.id_proveedor}">
						<a href="javascript:document.formElimi{$r.id_proveedor}.submit();" title="Eliminar Proveedor en Sistema" onclick="javascript:return(confirm(' Desea realmente Eliminar al Proveedor: {$r.nombre} ?')); location.href='proveedores_eliminar.php'">
							Eliminar>>
						</a>
					</form>
				</td>
