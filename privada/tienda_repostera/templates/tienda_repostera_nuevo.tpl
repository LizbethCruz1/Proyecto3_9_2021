...
<body>
	<div class="formu_ingreso_datos">
		<form action="tienda_repostera_nuevo1.php" method="post" name="formu">
			<h2>REGISTRAR TIENDA</h2>
				<input type="text" name="codigo" size="15" placeholder="codigo">(*)
				<p>
				...
				<p>
					<input type="text" name="pag_web" size="15" placeholder="Pagina Web" onkeyup="this.value=this.value.toUpperCase()">(*)
				</p>
				<p>
